...
Der Generator versucht zuerst **Playwright** für PDF (stabiler HTML->PDF-Export).
Wenn Playwright nicht installiert/verfügbar ist, wird auf den bisherigen Browser-CLI Weg zurückgefallen.
